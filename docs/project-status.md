...
当前 stable 为 T-232：release `20260717T111651Z-b30240a91398-5bf520393764`，revision `b30240a91398db707b513c54db50eef65cffbef7`，digest `5bf5203937646ae6a2791a7fe820972b88312139c95647f8fc436802674be7af`；release gate 在 Python 3.14 下通过 1109/1109 unittest、compileall 和 diff-check，独立门禁另通过 62/62 deterministic benchmark、22/22 architecture checks 与 session-continuity matrix。该版本继承 T-228 的 LSP/jdtls 边界，并增加 typed SessionTaskContinuity Owner：已写入但因 interrupt、budget、length 或 incomplete delivery 未完成的 code obligation 只有在 Git revision、授权路径、patch record 和当前内容 hash 全部仍新鲜时才跨轮延续；旧测试结果不复用，当前 read/test/diff/review 未闭合时不得交付。
