...
class BenchmarkTests(unittest.TestCase):
    def test_default_task_catalog_covers_representative_workflows(self) -> None:
        ...
        self.assertEqual(
            identifiers,
            {
                ...
                "readonly-typed-blocked-delivery",
                "run-tests-exec-boundary",
            },
        )
    ...
    def test_deterministic_suite_writes_json_and_markdown_reports(self) -> None:
        ...
        self.assertEqual(payload["passed"], 62)
        ...
        self.assertIn("readonly-typed-blocked-delivery", markdown)
        self.assertIn("run-tests-exec-boundary", markdown)
