...
class TuiAppTests(unittest.TestCase):
    ...
    def test_non_tty_falls_back_to_existing_chat(self) -> None:
        ...
        with patch("local_agent.frontends.tui.app.run_terminal_chat", return_value=0) as chat:
            code = run_tui(
                runtime,  # type: ignore[arg-type]
        ...
        self.assertIs(chat.call_args.kwargs["composer_history"], history)
    ...
    def test_initial_prompt_is_dispatched_by_worker_before_screen_exit(self) -> None:
        ...
        self.assertEqual(history.snapshot.local_entries, ("inspect project",))
